...
<body>
	...
	<p>您的身份是教师，正在使用教师版！</p>
		...
		<ul id="submenu01">
			<li><a href="tbUserServlet?method=findAllstudent" target="rightFrame">学生管理</a>
			</li>
		</ul>
		...
		<ul id="submenu04">
			<li><a href="tbUserServlet?method=showPersonone" target="rightFrame">修改个人信息</a>
			</li>
		</ul>
		<br><br>
		<p>老师您好！请记住你的职责：<br>
		1、请补全您信息，您的账号由管理员来分配。<br>
		2、请补全学生的学号等账号信息。</p>
	</div>
	</div>
</body>
