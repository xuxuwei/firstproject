...
<div style="margin-top:0px;">
	...
	<form action="tbUserServlet?method=personone" method="post">
	...
	<div class="lll" style="height:560px;width:1050px;margin-left:-5px;margin-top:-320px;margin-right:0px;marginborder-bottom:0px;background-color:#999999;float:left;">
